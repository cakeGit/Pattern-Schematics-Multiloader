...
public enum PatternSchematicsToolType {
  ...
  public MutableComponent getDisplayName() {
    ...
    : Component.translatable("create.schematic.tool." + Lang.asId(name())));
  }
  ...
  public List<Component> getDescription() {
    return (patternModId ? PatternSchematicsToolType.translatedOptions(PatternSchematics.MOD_ID + ".schematic.tool." + Lang.asId(name()) + ".description", "0", "1", "2", "3")
        : PatternSchematicsToolType.translatedOptions("create.schematic.tool." + Lang.asId(name()) + ".description", "0", "1", "2", "3"));
  }
