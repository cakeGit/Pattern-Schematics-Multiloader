...
public class PatternSchematicPonderScenes {
    ...
    public static void schematicPrinting(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay().showControls(
            Vec3.atCenterOf(schematicSavingFrom), Pointing.DOWN, 50
        ).rightClick().withItem(schematicAndQuillStack);
        scene.idle(30);
        scene.overlay().showControls(
            Vec3.atCenterOf(schematicSavingTo), Pointing.DOWN, 30
        ).rightClick().withItem(schematicAndQuillStack);
        scene.idle(50);
    ...
    public static void trainSchematicPrinting(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay().showOutlineWithText(util.select().fromTo(10, 3, 2, 10, 3, 4), 80)
            .placeNearTarget()
        ...
        scene.overlay().showControls(
            new Vec3(10.5, 3.5, 3.5), Pointing.DOWN, 50
        ...
        createWorld.animateBogey(util.grid().at(10, 3, 7), 1f, 10);
        
        for (int x = 10; x >= 9; x--) {
            for (int z = 2; z <= 4; z++) {
                createWorld.moveDeployer(util.grid().at(10, 3, z), 1, 4);
            }
            scene.idle(4);
            scene.world().showSection(util.select().fromTo(x, 1, 2, x, 2, 4), Direction.DOWN);
            scene.idle(1);
            for (int z = 2; z <= 4; z++) {
                createWorld.moveDeployer(util.grid().at(10, 3, z), -1, 4);
            }
        ...
        scene.overlay().showOutlineWithText(util.select().fromTo(9, 1, 2, 10, 2, 4), 80)
            .placeNearTarget()
        ...
        createWorld.animateBogey(util.grid().at(10, 3, 7), 8f, 80);
